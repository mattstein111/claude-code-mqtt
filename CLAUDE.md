...
- **Dependencies:** `@modelcontextprotocol/sdk`, `mqtt`, `zod`
...
mosquitto_pub -h localhost -t "chachi/sessions/default/inbox" \
...
- Don't hardcode topic prefixes — `chachi/` is a convention, not a requirement.
